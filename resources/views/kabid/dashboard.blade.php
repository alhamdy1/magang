...
@section('title', 'Dashboard Kabid - Sistem Perizinan Reklame')

@section('content')
<div class="mb-8">
    <h1 class="text-2xl font-bold text-gray-900">Dashboard Kabid Penyelenggaraan</h1>
        ...
        <div class="px-6 py-4 flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">
                    ...
                    Disetujui Kasi: {{ $permit->updated_at->format('d M Y') }}
                </p>
            </div>
            <div class="flex items-center space-x-4">
                <a href="{{ route('kabid.permits.show', $permit) }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700">
                    Lanjutkan Review
                </a>
            </div>
        </div>
...
<div class="bg-white rounded-lg shadow">
    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
        <h2 class="text-lg font-semibold text-gray-900">Permohonan dari Kasi</h2>
        <a href="{{ route('kabid.permits.index') }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
            Lihat Semua →
        </a>
    </div>
    <div class="divide-y divide-gray-200">
        ...
        <div class="px-6 py-4 flex items-center justify-between">
            ...
            <a href="{{ route('kabid.permits.show', $permit) }}" class="bg-green-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-green-700">
                Review
            </a>
        </div>
        @empty
