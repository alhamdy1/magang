...
@section('title', 'Daftar Permohonan - Kabid Penyelenggaraan')

@section('content')
<div class="mb-8">
    <h1 class="text-2xl font-bold text-gray-900">Permohonan untuk Review Final</h1>
    <p class="text-gray-600">Permohonan yang sudah disetujui oleh Kasi Perizinan</p>
</div>
    ...
    <table class="min-w-full divide-y divide-gray-200">
        <thead class="bg-gray-50">
            <tr>
                ...
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Disetujui Kasi</th>
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <a href="{{ route('kabid.permits.show', $permit) }}" class="bg-green-600 text-white px-3 py-1 rounded text-sm hover:bg-green-700">
                        Review
                    </a>
                </td>
            </tr>
