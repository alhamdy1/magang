...
@section('title', 'Review Permohonan - Kasi Perizinan')
...
<div class="mb-8 flex justify-between items-start">
    ...
    <a href="{{ route('kasi.permits.index') }}" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg font-medium hover:bg-gray-300">
        Kembali
    </a>
</div>
...
<div class="mb-6 p-4 rounded-lg bg-yellow-100 border border-yellow-400">
    <p class="text-sm text-yellow-800">
        <strong>Status:</strong> Sudah disetujui oleh Operator
...
<div class="mt-6 bg-white rounded-lg shadow p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- Approve Form -->
        <form action="{{ route('kasi.permits.approve', $permit) }}" method="POST">
            @csrf
            <div class="mb-4">
        ...
        <!-- Reject Form -->
        <form action="{{ route('kasi.permits.reject', $permit) }}" method="POST">
            @csrf
            <div class="mb-4">
