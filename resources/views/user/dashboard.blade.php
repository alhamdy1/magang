...
@section('title', 'Dashboard - Sistem Perizinan Reklame')
...
<!-- Quick Actions -->
<div class="mb-8">
    <a href="{{ route('user.permits.create') }}" class="bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 inline-flex items-center">
...
<div class="bg-white rounded-lg shadow">
    ...
    <div class="divide-y divide-gray-200">
        ...
        <div class="px-6 py-4 flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">{{ $permit->created_at->format('d M Y H:i') }} • {{ $permit->klasifikasi === 'permanen' ? 'Permanen' : 'Non Permanen' }}</p>
            </div>
            <div class="flex items-center space-x-4">
                ...
                <a href="{{ route('user.permits.show', $permit) }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
                    Lihat Detail
                </a>
            </div>
        </div>
        ...
        <div class="px-6 py-12 text-center">
            ...
            <a href="{{ route('user.permits.create') }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium mt-2 inline-block">
    ...
    <div class="px-6 py-4 border-t border-gray-200">
        <a href="{{ route('user.permits.index') }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium">
