        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nik" id="nik" value="{{ old('nik') }}" required
                    ...
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 @error('nik') border-red-500 @enderror">
                @error('nik')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
                <p class="mt-1 text-xs text-gray-500">NIK akan digunakan untuk tracking permohonan izin Anda</p>
            </div>
